...
export default function MorphCarousel({ title, description, sections, className = "" }: MorphCarouselProps) {
				...
				<AnimatePresence mode="wait">
					...
					>
						...
						<div className="p-10 flex-1 flex flex-col justify-center">
							<h2 className="text-3xl md:text-4xl font-extrabold mb-4 tracking-tight">{current.title}</h2>
							<p className="text-muted-foreground mb-6 text-lg md:text-xl">{current.paragraph}</p>
